...
export default function CubeRunnerPage() {
  ...
  return (
    <div className="flex flex-col items-center">
      <h1 className="text-3xl font-bold mb-4">3D Cube Runner</h1>
      ...
      <div className="mt-6 max-w-2xl">
        ...
        <p className="mb-4">
          Use the arrow keys or WASD to move the cube left and right. Avoid obstacles and collect power-ups to increase your score.
          The game gets faster as your score increases. How long can you survive?
        </p>
        <h2 className="text-xl font-bold mb-2">Controls</h2>
        <ul className="list-disc pl-5">
          <li>A/Left Arrow: Move left</li>
          <li>D/Right Arrow: Move right</li>
          <li>Space: Jump (if enabled)</li>
          <li>P: Pause game</li>
        </ul>
      </div>
    </div>
